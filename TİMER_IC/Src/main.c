...
int main(void)
{
	...
	double timer2_cnt_freq=0;    /* double kullanma sebebim user_signal_freq degeri  gerçek sayý olabilir */
...
void TIMER2_Init(void)
{
	...
	htimer2.Init.Period=0xFFFFFFFF;/*TIM2 için sayaç 32 bit tir referans manuel kontrol et */
	htimer2.Init.Prescaler=1; /*50/2=25Mhz olur formülden dolayý */
